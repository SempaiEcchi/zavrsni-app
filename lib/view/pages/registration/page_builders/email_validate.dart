...
import '../../../../infra/stores/registration_store.dart';

class EmailValidateScreen extends ConsumerStatefulWidget {
  const EmailValidateScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<EmailValidateScreen> createState() =>
      _EmailValidateScreenState();
}

class _EmailValidateScreenState extends ConsumerState<EmailValidateScreen> {
